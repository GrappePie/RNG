...
local shakeIntensity = 0.015 -- How much the Motor6D will shake (use small values)
local shakeDuration = 1 -- How long each shaking period will last (in seconds)
local shakeSpeed = 10 -- How fast the shaking will happen (in updates per second)
local originalC0 = motor.CFrame -- Save the original C0 of the Motor6D
...
function shakeMotor(intensity, speed)
	...
	motor.CFrame = originalC0 * CFrame.new(randomOffset)
