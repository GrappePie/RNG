...
local function CreateParticle_upvr(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10) -- Line 35, Named "CreateParticle"
	...
	TweenService_upvr:Create(clone_2, TweenInfo.new(arg3, Quart), tbl):Play()
...
local function CreateFlipbook_upvr(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10) -- Line 48, Named "CreateFlipbook"
	...
	TweenService_upvr:Create(clone_3, TweenInfo.new(1 / arg3 * 16, Quart_2), tbl_2):Play()
...
return function(arg1, arg2, arg3, arg4, arg5) -- Line 150
	--[[ Upvalues[14]:
		...
		[12]: TweenInfo_new_result1_upvr_3 (readonly)
	...
	coroutine.wrap(function() -- Line 180
		...
		while clone_4_upvr.Parent and var46_upvw do
			...
			TweenService_upvr:Create(clone, TweenInfo.new(var61, Enum.EasingStyle.Sine, Enum.EasingDirection.In), {
	...
	coroutine.wrap(function() -- Line 228
		...
		for i = 0, 10 do
			for _, v in Notes_upvr:GetChildren() do
				if v:IsA("Frame") and v.LayoutOrder == i then
					...
					TweenService_upvr:Create(class_ImageLabel, TweenInfo_new_result1_upvr_3, {
		...
		TweenService_upvr:Create(Notes_upvr, TweenInfo.new(2, Enum.EasingStyle.Quad, Enum.EasingDirection.InOut), {
			Size = UDim2.fromScale(1, 0.12);
		}):Play()
		for _, v_2 in Notes_upvr:GetChildren() do
			if v_2:IsA("Frame") then
				TweenService_upvr:Create(v_2:FindFirstChildOfClass("ImageLabel"), TweenInfo.new(2, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {
					ImageTransparency = 1;
				}):Play()
			end
		end
