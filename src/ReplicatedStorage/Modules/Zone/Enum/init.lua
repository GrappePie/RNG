...
function v1.createEnum(p3, p_u_4)
	...
	local v_u_21 = {
		["getName"] = function(p12)
			-- upvalues: (copy) v_u_10, (copy) v_u_11, (copy) p_u_4
			local v13 = tostring(p12)
			local v14 = v_u_10[v13] or v_u_11[v13]
			if v14 then
				return p_u_4[v14][1]
			end
		end,
		["getValue"] = function(p15)
			-- upvalues: (copy) v_u_9, (copy) v_u_11, (copy) p_u_4
			local v16 = tostring(p15)
			local v17 = v_u_9[v16] or v_u_11[v16]
			if v17 then
				return p_u_4[v17][2]
			end
		end,
		["getProperty"] = function(p18)
			...
			local v20 = v_u_9[v19] or v_u_10[v19]
			if v20 then
				return p_u_4[v20][3]
			end
		end
