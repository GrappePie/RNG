...
return function(_, p38, p39, p40, _)
	...
	v_u_2:Create(v43, Tween0o.new(1, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out), v_u_12)
	v_u_2:Create(v43, Tween0o.new(1, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out), v_u_13)
	local v47 = v_u_2:Create(v42, Tween0o.new(2, Enum.EasingStyle.Quart, Enum.EasingDirection.In), {
		["ImageTransparency"] = 0
	})
	local v48 = v_u_2:Create(v42, Tween0o.new(2, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {
		["ImageTransparency"] = 1
	})
	...
	v44.ImageColor3 = Color3.new(1, 1, 1)
	if not p40:GetAttribute("IgnoreTextColor") then
		v42.ImageColor3 = p40.TextColor3
		v44.ImageColor3 = v42.ImageColor3
	end
	...
	coroutine.wrap(function()
		...
		while v_u_10.Stepped:Wait() and v_u_50 do
			v_u_21(v_u_41, Color3.fromRGB(42, 81, 255), "rbxassetid://6909741538")
		end
	end)()
	coroutine.wrap(function()
		-- upvalues: (ref) v_u_50, (ref) v_u_31, (copy) v_u_41
		while task.wait(0.2) and v_u_50 do
			v_u_31(v_u_41, Color3.fromRGB(42, 81, 255))
		end
	end)()
	...
	p40.Visible = true
	v47:Play()
	v_u_37(v_u_41, Color3.fromRGB(42, 81, 255), 0.6, "rbxassetid://17272988611")
	task.wait(1)
	v_u_37(v_u_41, Color3.fromRGB(42, 81, 255), 0.3, "rbxassetid://17272988611")
	task.wait(1)
