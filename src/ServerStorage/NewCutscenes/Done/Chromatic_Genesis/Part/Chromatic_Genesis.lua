...
local module_4 = require(Modules:WaitForChild("Queue"))
...
local function CreateText_upvr_upvr(arg1, arg2, arg3) -- Line 30, Named "CreateText_upvr"
	...
	local any_new_result1_7_upvr = module_2_upvr.new(arg3)
...
local function CreateSideParticle_upvr_upvr(arg1, arg2) -- Line 120, Named "CreateSideParticle_upvr"
	...
	local any_new_result1_8_upvr = module_2_upvr.new(6909741538)
...
local function CreateFog_upvr_upvr(arg1, arg2) -- Line 160, Named "CreateFog_upvr"
	...
	local any_new_result1_11_upvr = module_2_upvr.new(1946917526)
...
local function CreateExplosionParticle_upvr_upvr(arg1, arg2, arg3) -- Line 232, Named "CreateExplosionParticle_upvr"
	...
	local any_new_result1_13_upvr = module_2_upvr.new(85238370434977)
...
local function _(arg1, arg2, arg3) -- Line 273
	--[[ Upvalues[4]:
		[1]: random_state_upvr_2 (readonly)
		[2]: module_2_upvr (readonly)
		[3]: TweenService_upvr_2 (readonly)
	...
	local any_new_result1_9 = module_2_upvr.new(16685733415)
...
local function CreateSideFog_upvr_upvr(arg1, arg2) -- Line 313, Named "CreateSideFog_upvr"
	...
	local any_new_result1_12_upvr = module_2_upvr.new(3318493505)
...
local function CreateIcon_upvr_upvr(arg1, arg2, arg3, arg4) -- Line 385, Named "CreateIcon_upvr"
	...
	local any_new_result1 = module_2_upvr.new(arg4)
...
local function _(arg1, ...) -- Line 411
	return ({...})[arg1]
end
...
return function(arg1, arg2) -- Line 434
	--[[ Upvalues[16]:
		[1]: module_5_upvr (readonly)
	...
	local Star2_upvr_2 = module_5_upvr.Star2
	local BlackBoard_upvr = module_5_upvr.BlackBoard
	local Colorboard = module_5_upvr.Colorboard
	local StarSpinSpeed = module_5_upvr.StarSpinSpeed
	local var285_upvw = true
	local current_thread_upvr = coroutine.running()
	local tbl_7_upvr = {}
	module_5_upvr.BlackBoardAppear:Play()
	...
	task.defer(function() -- Line 505
		...
		while true do
			...
			if not var294 then break end
			var294 = var285_upvw
			if not var294 then break end
			if math.random(0, 1) ~= 1 or Color3.fromRGB(147, 185, 255) then
			end
			var294 = table.insert
			var294(tbl_7_upvr, CreateText_upvr_upvr(BlackBoard_upvr, Color3.fromRGB(189, 167, 255), tbl_2_upvr[math.random(1, #tbl_2_upvr)]))
		end
	end)
	...
	task.defer(function() -- Line 569
		...
		while true do
			...
			if not var301 then break end
			var301 = var285_upvw
			if not var301 then break end
			var301 = CreateSideFog_upvr_upvr
			if math.random(0, 1) ~= 1 or Color3.fromRGB(110, 125, 255) then
			end
			var301(BlackBoard_upvr, Color3.fromRGB(159, 115, 255))
			var301 = CreateFog_upvr_upvr
			if math.random(0, 1) ~= 1 or Color3.fromRGB(110, 125, 255) then
			end
			var301(BlackBoard_upvr, Color3.fromRGB(159, 115, 255))
		end
	...
	task.defer(function() -- Line 610
		...
		while true do
			...
			if not var306 then break end
			if not var305_upvw then break end
	...
	for _ = 1, 15 do
		...
		script.Flash:Clone().Size = UDim2.fromScale(any_NextNumber_result1_11, any_NextNumber_result1_11)
		-- KONSTANTERROR: Expression was reused, decompilation is incorrect
		script.Flash:Clone().Position = UDim2.fromScale(random_state_upvr_2:NextNumber(), random_state_upvr_2:NextNumber())
		-- KONSTANTERROR: Expression was reused, decompilation is incorrect
		script.Flash:Clone().Parent = Colorboard
		-- KONSTANTERROR: Expression was reused, decompilation is incorrect
		...
		task.defer(function() -- Line 664
			...
			while true do
				...
				if not var314 then break end
				var314 = clone_6_upvr.Parent
				if not var314 then break end
				var314 = clone_6_upvr
				var314.Position = udim2_upvr_5 + UDim2.fromScale(ShakeSize_upvr_2.Value.X, ShakeSize_upvr_2.Value.Y)
			end
		end)
		task.wait(0.01)
	end
	...
	task.defer(function() -- Line 707
		...
		while true do
			...
			if not var320 then break end
			var320 = clone_4_upvr_3.Parent
			if not var320 then break end
			var320 = clone_4_upvr_3
			var320.Position = UDim2.fromScale(0.5, 0.5) + UDim2.fromScale(math.random(-2, 2) / 100, math.random(-2, 2) / 100)
		end
	end)
	task.wait(0.5)
	var305_upvw = false
