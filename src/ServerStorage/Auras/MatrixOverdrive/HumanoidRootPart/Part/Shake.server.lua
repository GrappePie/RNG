...
local shakeIntensity = 0.25 -- How much the Motor6D will shake (use small values)
local shakeDuration = 2 -- How long each shaking period will last (in seconds)
local shakeSpeed = 30 -- How fast the shaking will happen (in updates per second)
