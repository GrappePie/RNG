...
local tweenDuration = 3.5 -- Duration of the tween in seconds
local waitDuration = 5 -- Duration to wait before starting the reverse tween

-- Define the starting and ending colors
local targetColor = Color3.fromRGB(69, 133, 81) -- Green color
local mainColor = Color3.fromRGB(163, 162, 165) 
