	...
	if not p_u_35:_preventMultiFrameUpdates("update") then
		...
		for v_u_36, _ in pairs(p_u_35.characters) do
			...
			if v37 then
				...
				local v_u_39 = p_u_35.janitor:add(v_u_3.new(), "destroy", "trackCharacterParts-" .. p_u_35.name)
				for _, v_u_40 in pairs(v_u_36:GetChildren()) do
					if v_u_40:IsA("BasePart") and not v_u_4.bodyPartsToIgnore[v_u_40.Name] then
						p_u_35.partToItem[v_u_40] = v_u_36
						local v41 = p_u_35.parts
						table.insert(v41, v_u_40)
						v_u_39:add(v_u_40.AncestryChanged:Connect(function()
							-- upvalues: (copy) v_u_40, (ref) v_u_39, (copy) p_u_35
							if not v_u_40:IsDescendantOf(game) and v_u_40.Parent == nil and v_u_39 ~= nil then
								v_u_39:destroy()
								v_u_39 = nil
								p_u_35:update()
							end
				...
				v_u_39:add(v_u_36.AncestryChanged:Connect(function()
					-- upvalues: (copy) v_u_36, (ref) v_u_39, (copy) p_u_35
					if not v_u_36:IsDescendantOf(game) and v_u_36.Parent == nil and v_u_39 ~= nil then
						v_u_39:destroy()
						v_u_39 = nil
						p_u_35:update()
					end
				end), "Disconnect")
				local v42 = p_u_35.items
				table.insert(v42, v_u_36)
			end
		end
		for v43, _ in pairs(p_u_35.baseParts) do
			local v44 = v43.Size
			local v45 = v44.X * v44.Y * v44.Z
			p_u_35.totalVolume = p_u_35.totalVolume + v45
			p_u_35.partToItem[v43] = v43
			local v46 = p_u_35.parts
			table.insert(v46, v43)
			local v47 = p_u_35.items
			table.insert(v47, v43)
		end
