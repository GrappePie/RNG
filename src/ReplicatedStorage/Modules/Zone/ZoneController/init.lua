...
function v_u_20.getTouchingZones(p119, p120, p121, p122)
	...
	local v134 = {}
	local v135 = {}
	local v136 = v_u_4:GetPartBoundsInBox(v126, v125, v133)
	local v137 = {}
	...
	if 0 < v140 then
		...
		for _, v143 in pairs(v129) do
			...
			if v143:IsA("BasePart") then
				if not (v128 and v_u_3.bodyPartsToIgnore[v143.Name]) then
					local v145 = v_u_4:GetPartsInPart(v143, v142)
					for _, v146 in pairs(v145) do
						if not v134[v146] then
	...
	for v150, _ in pairs(v135) do
		if v149 == nil or v150._currentExitDetection < v149 then
			v149 = v150._currentExitDetection
		end
		table.insert(v148, v150)
	end
	if v149 and p122 then
		p122.exitDetections[p119] = v149
	end
	return v148, v134
end
local v_u_151 = {}
