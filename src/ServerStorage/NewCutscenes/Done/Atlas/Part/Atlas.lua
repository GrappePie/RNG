...
-- Decompiled on 2024-12-15 15:40:37
-- Luau version 6, Types version 3
-- Time taken: 0.008831 seconds
...
local function CreateParticle_upvr(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10) -- Line 33, Named "CreateParticle"
	--[[ Upvalues[3]:
	...
	TweenService_upvr:Create(clone, Tween0o.new(arg3, Quart), tbl_2):Play()
...
local function CreateFlipbook_upvr(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10) -- Line 46, Named "CreateFlipbook"
	--[[ Upvalues[3]:
	...
	tbl.ImageTransparency = Quart_2
	TweenService_upvr:Create(clone_2, Tween0o.new(1 / arg3 * 16, Quart_2), tbl):Play()
...
local function CreateParticleEmit_upvr(arg1, arg2, arg3) -- Line 69, Named "CreateParticleEmit"
	--[[ Upvalues[5]:
...
local function CreateMark_upvr(arg1, arg2) -- Line 98, Named "CreateMark"
	--[[ Upvalues[5]:
	...
	ImageLabel.Image = "rbxassetid://137937406893831"
...
local function CreateFog_upvr(arg1, arg2) -- Line 117, Named "CreateFog"
	--[[ Upvalues[5]:
		[1]: TweenService_upvr (readonly)
		[2]: Tween0o_new_result1_upvr_3 (readonly)
		[3]: Tween0o_new_result1_upvr_2 (readonly)
...
return function(arg1) -- Line 149
	...
	local Texts_upvr = clone_4_upvr:WaitForChild("Texts")
	local var52_upvw
	var52_upvw = RunService_upvr.Heartbeat:Connect(function(arg1_2) -- Line 162
		--[[ Upvalues[6]:
			[1]: clone_4_upvr (readonly)
			[2]: Star_upvr (readonly)
			[3]: SpinSpeed_upvr (copied, readonly)
			[4]: ShakeSize_upvr (copied, readonly)
			[5]: Texts_upvr (readonly)
			[6]: var52_upvw (read and write)
		]]
		if clone_4_upvr.Parent then
			local var55 = Star_upvr
			var55.Rotation += arg1_2 * 60 * SpinSpeed_upvr.Value
			...
			for _, v in Texts_upvr:GetChildren() do
				if v:IsA("TextLabel") then
					v.Rotation = -Texts_upvr.Rotation
				end
			end
		else
	...
	TweenService_upvr:Create(Texts_upvr, Tween0o.new(3, Enum.EasingStyle.Quart, Enum.EasingDirection.InOut, 0, false, 1), {
		Rotation = 0;
		Size = UDim2.fromScale(0.6, 0.6);
		GroupTransparency = 0.4;
	}):Play()
	coroutine.wrap(function() -- Line 189
		--[[ Upvalues[2]:
			[1]: TweenService_upvr (copied, readonly)
			[2]: Texts_upvr (readonly)
		]]
		task.wait(4)
		TweenService_upvr:Create(Texts_upvr, Tween0o.new(5.23, Enum.EasingStyle.Quart, Enum.EasingDirection.In), {
			Rotation = -120;
			Size = UDim2.fromScale(1, 1);
		}):Play()
	end)()
	coroutine.wrap(function() -- Line 194
		--[[ Upvalues[6]:
			[1]: clone_4_upvr (readonly)
		...
		while clone_4_upvr.Parent and var46_upvw do
			...
			local var70 = math.random(10, 20) / 10
			local clone_3 = Particle_upvr:Clone()
			clone_3.Parent = clone_4_upvr
			clone_3.Size = UDim2.fromScale(0.05, 0.05)
			clone_3.SizeConstraint = Enum.SizeConstraint.RelativeYY
			clone_3.Image = "rbxassetid://13903581452"
			clone_3.Position = UDim2.fromScale(math.random(0, 100) / 100, math.random(0, 100) / 100)
			TweenService_upvr:Create(clone_3, Tween0o.new(var70, Enum.EasingStyle.Sine, Enum.EasingDirection.In), {
				Position = clone_3.Position + UDim2.fromScale(0.02, -0.02);
				Size = UDim2.fromScale(0, 0);
			}):Play()
			Debris_upvr:AddItem(clone_3, var70)
			task.wait(0.05)
		end
	end)()
	coroutine.wrap(function() -- Line 215
		...
		while clone_4_upvr.Parent and var46_upvw do
			...
			task.defer(CreateFlipbook_upvr, "http://www.roblox.com/asset/?id=14820078557", clone_4_upvr, 40, UDim2.fromScale(0.5, 0.5), UDim2.fromScale(0.2, 0.2), UDim2.fromScale(1, 1), Enum.SizeConstraint.RelativeYY, math.random(0, 360), 0.5, true)
	...
	coroutine.wrap(function() -- Line 228
		...
		while clone_4_upvr.Parent and var46_upvw do
			CreateFog_upvr(clone_4_upvr, Color3.new(1, 0.666667, 0.501961))
			task.wait(0.2)
		end
	end)()
