...
function v_u_4.__index.LinkToInstance(p_u_40, p41, p42)
	...
	v_u_43 = p41.AncestryChanged:Connect(v49)
	v_u_47.Connection = v_u_43
	if v_u_45 then
		local v50 = p41.Parent
		if v_u_47.Connected then
			if v50 == nil then
				v_u_45 = true
			else
			...
			if v_u_45 then
				coroutine.wrap(function()
					-- upvalues: (ref) v_u_1, (copy) v_u_47, (ref) v_u_43, (copy) p_u_40, (ref) v_u_45
					v_u_1:Wait()
					if v_u_47.Connected then
						if v_u_43.Connected then
							while v_u_45 and v_u_43.Connected and v_u_47.Connected do
...
function v_u_4.__index.LinkToInstances(p51, ...)
	-- upvalues: (copy) v_u_4
	local v52 = v_u_4.new()
	for _, v53 in ipairs({ ... }) do
		v52:Add(p51:LinkToInstance(v53, true), "Disconnect")
	end
	return v52
end
for v54, v55 in next, v_u_4.__index do
	local v56 = string.lower(v54)
	local v57 = string.sub(v56, 1, 1) .. string.sub(v54, 2)
	v_u_4.__index[v57] = v55
end
return v_u_4