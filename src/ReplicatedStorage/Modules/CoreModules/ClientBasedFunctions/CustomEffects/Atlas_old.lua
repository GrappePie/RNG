...
local function v26_upvr(arg1, arg2, arg3) -- Line 24, Named "v26"
	...
	TweenService_upvr:Create(ImageLabel_upvr, TweenInfo_new_result1_upvr_4, {
		ImageTransparency = 0;
	}):Play()
	local var13 = 50
...
local function v33_upvr(arg1, arg2, arg3) -- Line 58, Named "v33"
	...
	TweenService_upvr:Create(ImageLabel_3, TweenInfo.new(var21, Enum.EasingStyle.Linear), {
...
local TweenInfo_new_result1_upvr_5 = TweenInfo.new(6, Enum.EasingStyle.Quart, Enum.EasingDirection.In)
local TweenInfo_new_result1_upvr_3 = TweenInfo.new(1, Enum.EasingStyle.Quart)
return function(arg1, arg2, arg3, arg4, arg5) -- Line 126
	--[[ Upvalues[14]:
		...
		[11]: TweenInfo_new_result1_upvr (readonly)
		[12]: TweenInfo_new_result1_upvr_5 (readonly)
		[13]: v49_upvr (readonly)
		[14]: TweenInfo_new_result1_upvr_3 (readonly)
	]]
	...
	task.wait(3.23)
	TweenService_upvr:Create(StarSpinSpeed, TweenInfo_new_result1_upvr_5, {
		Value = 4;
	}):Play()
	TweenService_upvr:Create(Star, TweenInfo_new_result1_upvr_5, {
	...
	TweenService_upvr:Create(arg4, TweenInfo_new_result1_upvr_3, {
