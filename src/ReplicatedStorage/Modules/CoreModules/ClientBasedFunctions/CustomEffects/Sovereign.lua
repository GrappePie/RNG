...
local v_u_17 = Color3.fromHex("1770ff")
local v_u_18 = Color3.fromHex("ffeb50")
...
local function v_u_50(p46)
	...
	v47.ImageColor3 = Color3.fromRGB(255, 250, 117)
	...
	v49.Parent = v47
	v_u_2:Create(v48, TweenInfo.new(3.75, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {
		["Offset"] = Vector2.new(2, 0)
	}):Play()
	v_u_2:Create(v47, TweenInfo.new(3.75, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {
...
return function(_, p51, p52, p53, _)
	...
	v_u_2:Create(v56, TweenInfo.new(1, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out), v_u_13)
	v_u_2:Create(v56, TweenInfo.new(1, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out), v_u_14)
	...
	coroutine.wrap(function()
		...
		while v_u_10.Stepped:Wait() and v_u_63 do
			v_u_29(v_u_54, Color3.fromRGB(42, 81, 255), "rbxassetid://17692000754")
		end
	end)()
	coroutine.wrap(function()
		-- upvalues: (ref) v_u_63, (ref) v_u_39, (copy) v_u_54
		while task.wait(0.2) and v_u_63 do
			v_u_39(v_u_54, Color3.fromRGB(42, 81, 255))
		end
	end)()
	...
	p53.Visible = true
	v60:Play()
	v_u_45(v_u_54, Color3.fromRGB(255, 250, 106), 0.6, "rbxassetid://17692043862")
	task.wait(1)
	v_u_45(v_u_54, Color3.fromRGB(255, 250, 106), 0.3, "rbxassetid://17692043862")
	task.wait(1)
