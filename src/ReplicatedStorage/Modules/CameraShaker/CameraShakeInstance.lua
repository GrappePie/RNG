...
function v_u_1.new(p4, p5, p6, p7)
	...
	local v14 = {
		...
		["fadeInDuration"] = v8,
		["sustain"] = 0 < v8,
		["currentFadeTime"] = 0 < v8 and 0 or 1,
...
function v_u_1.UpdateShake(p16, p17)
	...
	if 0 < p16.fadeInDuration then
		if p16.sustain then
			if v19 < 1 then
				v19 = v19 + p17 / p16.fadeInDuration
			elseif 0 < p16.fadeOutDuration then
				p16.sustain = false
			end
		end
	end
...
function v_u_1.IsShaking(p32)
	return 0 < p32.currentFadeTime and true or p32.sustain
end
function v_u_1.IsFadingOut(p33)
	local v34 = not p33.sustain
	if v34 then
		v34 = 0 < p33.currentFadeTime
	end
	return v34
end
