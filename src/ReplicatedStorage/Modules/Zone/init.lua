...
function v_u_17.fromRegion(p35, p36)
	...
	local function v_u_43(p38, p39)
		...
		if 2024 < p39.X or 2024 < p39.Y or 2024 < p39.Z then
			local v40 = p39 * 0.25
			local v41 = p39 * 0.5
	...
	for v67, v68 in pairs(v47) do
		for _, v72 in pairs(v68.Values) do
			...
			if not p46 then
				...
				local v72 = 4 * math.floor(v71)
			end
			table.insert(v70, v72)
		end
	end
	local v73 = unpack
	local v74 = Vector3.new(v73(v65))
	local v75 = unpack
	local v76 = Vector3.new(v75(v66))
...
function v_u_17._updateOccupants(p111, p112, p113)
	...
	for v120, _ in pairs(p113) do
		if v114[v120] == nil then
			v114[v120] = v120:IsA("Player") and v120.Character or true
		...
		v_u_144:add(v_u_3:Connect(function()
			...
			if v_u_140 <= v147 then
				...
				if v_u_141 then
					...
					if 1.5 < (p_u_138.Position - v_u_142).Magnitude and v148 <= v147 - v_u_143 then
						v_u_144:cleanup()
						return
					end
				end
...
function v_u_17._getRegionConstructor(p156, p_u_157, p158)
	...
	local v162 = nil
	if v159 then
		if p156.allZonePartsAreBlocks then
